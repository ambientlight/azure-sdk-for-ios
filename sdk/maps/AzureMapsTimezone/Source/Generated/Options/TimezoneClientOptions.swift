...
public struct TimezoneClientOptions: ClientOptions {
    ...
    /// Initialize a `TimezoneClientOptions` structure.
    /// - Parameters:
    ...
    public init(
        apiVersion: TimezoneClientOptions.ApiVersion = .latest,
        logger: ClientLogger = ClientLoggers.default(tag: "Timezone"),
