...
/// User-configurable options for the `GetTimezoneByCoordinates` operation.
public struct GetTimezoneByCoordinatesOptions: RequestOptions {
    ...
    /// Initialize a `GetTimezoneByCoordinatesOptions` structure.
    /// - Parameters:
