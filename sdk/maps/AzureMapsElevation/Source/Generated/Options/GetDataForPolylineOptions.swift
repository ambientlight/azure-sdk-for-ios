...
/// User-configurable options for the `GetDataForPolyline` operation.
internal struct GetDataForPolylineOptions: RequestOptions {
    ...
    /// Initialize a `GetDataForPolylineOptions` structure.
    /// - Parameters:
