...
public struct ElevationClientOptions: ClientOptions {
    ...
    /// Initialize a `ElevationClientOptions` structure.
    /// - Parameters:
    ...
    public init(
        apiVersion: ElevationClientOptions.ApiVersion = .latest,
        logger: ClientLogger = ClientLoggers.default(tag: "Elevation"),
