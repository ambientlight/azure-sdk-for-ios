...
public struct TrafficClientOptions: ClientOptions {
    ...
    /// Initialize a `TrafficClientOptions` structure.
    /// - Parameters:
    ...
    public init(
        apiVersion: TrafficClientOptions.ApiVersion = .latest,
        logger: ClientLogger = ClientLoggers.default(tag: "Traffic"),
