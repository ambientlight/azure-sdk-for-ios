...
public struct GeolocationClientOptions: ClientOptions {
    ...
    /// Initialize a `GeolocationClientOptions` structure.
    /// - Parameters:
    ...
    public init(
        apiVersion: GeolocationClientOptions.ApiVersion = .latest,
        logger: ClientLogger = ClientLoggers.default(tag: "Geolocation"),
