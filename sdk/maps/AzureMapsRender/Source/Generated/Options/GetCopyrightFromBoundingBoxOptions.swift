...
/// User-configurable options for the `GetCopyrightFromBoundingBox` operation.
internal struct GetCopyrightFromBoundingBoxOptions: RequestOptions {
    /// Yes/no value to exclude textual data from response. Only images and country names will be in response.
    internal let includeText: IncludeText?
    ...
    /// Initialize a `GetCopyrightFromBoundingBoxOptions` structure.
    /// - Parameters:
