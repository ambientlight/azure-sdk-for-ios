...
/// User-configurable options for the `GetCopyrightForWorld` operation.
internal struct GetCopyrightForWorldOptions: RequestOptions {
    ...
    /// Initialize a `GetCopyrightForWorldOptions` structure.
    /// - Parameters:
