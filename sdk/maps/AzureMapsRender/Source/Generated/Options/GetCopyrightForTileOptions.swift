...
/// User-configurable options for the `GetCopyrightForTile` operation.
internal struct GetCopyrightForTileOptions: RequestOptions {
    ...
    /// Initialize a `GetCopyrightForTileOptions` structure.
    /// - Parameters:
