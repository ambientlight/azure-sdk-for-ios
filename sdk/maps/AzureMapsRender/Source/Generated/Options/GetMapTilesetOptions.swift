...
/// User-configurable options for the `GetMapTileset` operation.
internal struct GetMapTilesetOptions: RequestOptions {
    ...
    /// Initialize a `GetMapTilesetOptions` structure.
    /// - Parameters:
