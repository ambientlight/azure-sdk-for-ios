...
/// User-configurable options for the `GetMapStateTile` operation.
internal struct GetMapStateTileOptions: RequestOptions {
    ...
    /// Initialize a `GetMapStateTileOptions` structure.
    /// - Parameters:
