...
public struct RenderClientOptions: ClientOptions {
    ...
    /// Initialize a `RenderClientOptions` structure.
    /// - Parameters:
    ...
    public init(
        apiVersion: RenderClientOptions.ApiVersion = .latest,
        logger: ClientLogger = ClientLoggers.default(tag: "Render"),
