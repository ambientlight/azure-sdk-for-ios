...
/// User-configurable options for the `RequestRouteMatrixSync` operation.
internal struct RequestRouteMatrixSyncOptions: RequestOptions {
    ...
    internal let waitForResults: Bool?
    ...
    /// Initialize a `RequestRouteMatrixSyncOptions` structure.
    /// - Parameters:
