...
/// User-configurable options for the `GetRouteMatrix` operation.
internal struct GetRouteMatrixOptions: RequestOptions {
    ...
    /// Initialize a `GetRouteMatrixOptions` structure.
    /// - Parameters:
