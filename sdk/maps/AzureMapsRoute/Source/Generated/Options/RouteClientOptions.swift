...
public struct RouteClientOptions: ClientOptions {
    ...
    /// Initialize a `RouteClientOptions` structure.
    /// - Parameters:
    ...
    public init(
        apiVersion: RouteClientOptions.ApiVersion = .latest,
        logger: ClientLogger = ClientLoggers.default(tag: "Route"),
