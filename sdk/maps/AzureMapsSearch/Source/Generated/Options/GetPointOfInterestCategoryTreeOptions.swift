...
/// User-configurable options for the `GetPointOfInterestCategoryTree` operation.
internal struct GetPointOfInterestCategoryTreeOptions: RequestOptions {
    ...
    /// Initialize a `GetPointOfInterestCategoryTreeOptions` structure.
    /// - Parameters:
