...
internal struct SearchStructuredAddressOptions: RequestOptions {
    ...
    internal let streetNumber: String?
    /// The street name portion of an address
    internal let streetName: String?
    /// The cross street name for the structured address
    internal let crossStreet: String?
    ...
    internal let municipalitySubdivision: String?
    /// The named area for the structured address
    internal let countryTertiarySubdivision: String?
    /// The county for the structured address
    internal let countrySecondarySubdivision: String?
    /// The country subdivision portion of an address
    internal let countrySubdivision: String?
