...
/// User-configurable options for the `FuzzySearch` operation.
public struct FuzzySearchOptions: RequestOptions {
    ...
    public let minFuzzyLevel: Int32?
    ...
    /// * Level 4 doesn’t add any more spell checking functions.
    /// The search engine will start looking for a match on the level defined by minFuzzyLevel, and will stop searching at the level specified by maxFuzzyLevel.
    public let maxFuzzyLevel: Int32?
    ...
    /// Initialize a `FuzzySearchOptions` structure.
    /// - Parameters:
    ...
    public init(
        ...
        minFuzzyLevel: Int32? = nil,
        maxFuzzyLevel: Int32? = nil,
