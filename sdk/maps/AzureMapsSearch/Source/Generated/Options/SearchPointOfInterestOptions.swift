...
/// User-configurable options for the `SearchPointOfInterest` operation.
internal struct SearchPointOfInterestOptions: RequestOptions {
    ...
    internal let extendedPostalCodesFor: [PointOfInterestExtendedPostalCodes]?
    ...
    /// Initialize a `SearchPointOfInterestOptions` structure.
    /// - Parameters:
    ...
    internal init(
        ...
        btmRight: String? = nil,
        language: String? = nil,
        extendedPostalCodesFor: [PointOfInterestExtendedPostalCodes]? = nil,
