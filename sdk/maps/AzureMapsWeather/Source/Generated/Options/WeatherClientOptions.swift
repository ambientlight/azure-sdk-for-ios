...
public struct WeatherClientOptions: ClientOptions {
    ...
    /// Initialize a `WeatherClientOptions` structure.
    /// - Parameters:
    ...
    public init(
        apiVersion: WeatherClientOptions.ApiVersion = .latest,
        logger: ClientLogger = ClientLoggers.default(tag: "Weather"),
