...
/// User-configurable options for the `GetDailyForecast` operation.
internal struct GetDailyForecastOptions: RequestOptions {
    ...
    /// Initialize a `GetDailyForecastOptions` structure.
    /// - Parameters:
